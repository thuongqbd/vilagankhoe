jQuery(document).ready(function($) {
        ...
        if (faqContainer.is(".collapsible")) {
            faq.find(".qafp-faq-anchor").bind("click", function() {
                ...
                if (faqContainer.is(".accordion")){
					$(".qafp-faq-answer").not("#qafp-faq" + num + " .qafp-faq-answer").hide();					
				} 
                if (faqContainer.is(".animation-fade")){
					faq.find(".qafp-faq-answer").fadeToggle(function(){
						
						var obj = $(this).siblings('.qafp-faq-title');
						if(obj.is('.active')){
					...
					faq.find(".qafp-faq-answer").slideToggle();
				}
                else {
					faq.find(".qafp-faq-answer").toggle();
				}
                if (faqContainer.is(".focus")) {
    ...
    $(".qafp-faq-anchor").click(function() {
        if ($(this).find(".qafp-fa-caret-right").hasClass("qafp-fa-open")) $(this).find(".qafp-fa-caret-right").removeClass("qafp-fa-open");
        else {
            if (faqContainer.is(".accordion")) $(".qafp-fa-open").removeClass("qafp-fa-open", 1E3);
            $(this).find(".qafp-fa-caret-right").addClass("qafp-fa-open",
                1E3);
            return false
        }
    });
