...
Tags:  responsive, android, iphone, jquery, menu, mobile, navigation, phone, tablet, multilevel, multilevel-menu
...
Awesome Responsive Menu Plugin will help You to convert WordPress menu to responsive menu and It's easily customizable form WordPress admin and also Different types effects available for menu . 

== Description ==

Worpdress Awesome Responsive Menu Plugin will help You to convert WordPress menu to responsive menu and It's easily customizable form wordpress admin . 
...
== Screenshots ==
1. Awesome Responsive Menu admin setting
2. Awesome Responsive Frentend View
