...
$ap_form_content = in_array('post_content',$ap_settings['form_included_fields'])?wp_kses_post($_POST['ap_form_content_editor']):null;
$error = new stdClass();
$error_flag = 0;
$image_error_flag = 0;
...
if($error_flag==0)
{
    ...
    if($ap_form_content=='' && in_array('post_content',$ap_settings['form_included_fields']))//if post content is left blank
    {
        $post_title_error = __('This field is required','anonymous-post');
