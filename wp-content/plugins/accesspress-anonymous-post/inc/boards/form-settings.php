    ...
    <div class="ap-tab-wrapper">
      <div class="ap-option-wrapper">
        ...
        <div class="ap-each-config-wrapper">
          ...
          <div class="ap-fields-configurations">
            <div class="ap-included-single-wrap">
              <label><input type="checkbox" name="form_included_fields[]" value="post_content"/><span><?php _e('Show on form','anonymous-post');?></span></label>
            </div>
            <div class="ap-included-single-wrap">
              <label><input type="checkbox" name="form_required_fields[]" value="post_content"/><span><?php _e('Required','anonymous-post');?></span></label>
            </div>
             <div class="ap-included-single-wrap">
...
<div class="ap-option-wrapper">
    <label><?php _e('Post type','anonymous-post');?></label>
    <div class="ap-option-field">
	  ...
	  foreach($post_type as $key => $type)
          {
            ?>
            <option value="<?php echo $key;?>" <?php if(isset($ap_settings['post_type']) && $ap_settings['post_type']==$key){?>selected="selected"<?php }?>><?php echo $type;?></option>
            <?php 
          }
	  ?>
		</select>
