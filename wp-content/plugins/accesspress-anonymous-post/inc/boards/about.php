<div class="ap-tabs-board" id="board-about-settings" style="display: none;">
	...
	<div class="ap-tab-wrapper">
		...
		<p><strong>AccessPress Anonymous Post</strong> - is a responsive HTML5 form to permit your website users (guests/visitors/not logged in users) to submit a standard WordPress Post in a simple and customized manner, with featured image and many other options. </p>
		<div class="halfseperator"></div>
		<p><strong>Please visit our product page for more details here:</strong><br />
			<a href="http://accesspressthemes.com/wordpress-plugins/accesspress-anonymous-post/" target="_blank">http://accesspressthemes.com/wordpress-plugins/accesspress-anonymous-post/</a></p>
			<div class="halfseperator"></div>
			<p><strong>Plugin documentation can be found here:</strong><br />
				<a href="http://accesspressthemes.com/wordpress-plugin-instruction-anonymous-post/" target="_blank">http://accesspressthemes.com/wordpress-plugin-instruction-anonymous-post/</a></p>
				<div class="halfseperator"></div>
