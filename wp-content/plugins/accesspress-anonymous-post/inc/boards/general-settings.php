	...
	<div class="ap-tab-wrapper">
		...
		<div class="ap-option-wrapper">
			...
			<div class="ap-option-field">
				...
				<div class="ap-admin-email-list"></div>
				<div class="ap-admin-email-add-btn"><input type="button" value="<?php _e('Add Email Address', 'anonymous-post'); ?>" class="button primary-button" id="ap-admin-email-add-trigger"></div>
				<input type="hidden" id="ap-admin-email-counter" value="0">
			</div>
		</div>
		<div class="ap-option-wrapper">
			<label class="ap-check-login"><?php _e('Admin Notification Subject:', 'anonymous-post'); ?></label>
			<div class="ap-option-field">
				<input type="text" name="admin_notification_subject" value="<?php echo $this->output_converting_br($ap_settings['admin_notification_subject']); ?>">
			</div>
		</div>
		<div class="ap-option-wrapper">
			<label class="ap-check-login"><?php _e('Admin Notification Message:', 'anonymous-post'); ?></label>
			<div class="ap-option-field">
				<div class="ap-option-checkbox-field">
					<div class="ap-checkbox-form"><textarea name="admin_notification_message" rows="10" cols="41"><?php echo $this->output_converting_br($ap_settings['admin_notification_message']); ?></textarea></div>
					<div class="ap-option-note  ap-option-width"><?php _e('You can use #post_title,#post_admin_link,#post_author_name,#post_author_email,#post_author_url codes in the above message to get the respective values in the email.', 'anonymous-post'); ?></div>
				</div>
			</div>
		</div>
		<div class="ap-option-wrapper">
