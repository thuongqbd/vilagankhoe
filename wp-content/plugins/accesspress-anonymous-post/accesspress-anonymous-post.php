 ...
 **/
 ...
 if(!defined('AP_IMAGE_DIR'))
 {
    define('AP_IMAGE_DIR',plugin_dir_url( __FILE__ ).'images');
 }
 if(!defined('AP_JS_DIR'))
 {
    define('AP_JS_DIR',plugin_dir_url( __FILE__ ).'js');
 }
 if(!defined('AP_CSS_DIR'))
 {
    define('AP_CSS_DIR',plugin_dir_url( __FILE__ ).'css');
 }
 if(!defined('AP_VERSION'))
 {
    define('AP_VERSION','2.3.7');
 }
